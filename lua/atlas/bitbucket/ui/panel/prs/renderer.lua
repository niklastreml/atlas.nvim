...
local overview_tab = require("atlas.bitbucket.ui.panel.prs.tabs.overview")
local activity_tab = require("atlas.bitbucket.ui.panel.prs.tabs.activity")
local comments_tab = require("atlas.bitbucket.ui.panel.prs.tabs.comments")
local commits_tab = require("atlas.bitbucket.ui.panel.prs.tabs.commits")
local files_tab = require("atlas.bitbucket.ui.panel.prs.tabs.files")
