...
---@class BitbucketRepositoryCloneLink
---@field name string
---@field href string

---@class BitbucketRepositoryLinks
---@field self BitbucketRepositoryLink
---@field html BitbucketRepositoryLink
---@field avatar BitbucketRepositoryLink
---@field pullrequests BitbucketRepositoryLink
---@field commits BitbucketRepositoryLink
---@field branches BitbucketRepositoryLink
---@field tags BitbucketRepositoryLink
---@field downloads BitbucketRepositoryLink
---@field source BitbucketRepositoryLink
---@field forks BitbucketRepositoryLink|nil
---@field watchers BitbucketRepositoryLink|nil
---@field hooks BitbucketRepositoryLink|nil
---@field clone BitbucketRepositoryCloneLink[]

---@class BitbucketRepositoryOwner
---@field type string
---@field display_name string
---@field uuid string
---@field username string

---@class BitbucketRepositoryWorkspaceRef
---@field type string
---@field uuid string
---@field name string
---@field slug string

---@class BitbucketRepositoryProjectRef
---@field type string
---@field key string
---@field uuid string
---@field name string
...
---@class BitbucketRepositoryOverrideSettings
---@field default_merge_strategy boolean|nil
---@field branching_model boolean|nil
...
---@field description string
---@field scm string
---@field website string|nil
---@field language string
---@field uuid string
---@field is_private boolean
---@field size number
---@field fork_policy string
---@field created_on string
---@field updated_on string
---@field links BitbucketRepositoryLinks
---@field owner BitbucketRepositoryOwner
---@field workspace BitbucketRepositoryWorkspaceRef
---@field project BitbucketRepositoryProjectRef|nil
---@field mainbranch BitbucketRepositoryMainBranch|nil
---@field override_settings BitbucketRepositoryOverrideSettings|nil
---@field parent table|nil
---@field enforced_signed_commits boolean|nil
